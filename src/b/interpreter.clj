...
;; datastructure
;;      (b.interpreter/AAddExpression
;;      (b.interpreter/AIntegerExpression "4")
;;      (b.interpreter/AIntegerExpression "1"))
...
;; generate a marco for each syntax tree node that should be removed
...
;; them. At first glance this allowes us to use 1=1 as an expression
...
;; According to the B-Book, division is only defined for natural
;; numbers. Also the divisor must not be zero.
(defn bdiv [n m]
...
;; also dispach ob the types of the arguments.
(defn bmult [a b]
